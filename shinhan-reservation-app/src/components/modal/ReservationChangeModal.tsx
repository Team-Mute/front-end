...
import { updateReservationApi } from '@/lib/api/reservation'; // 실제 사용할 예약 수정 API
...
// --- 컴포넌트 ---
export default function ReservationChangeModal({ isOpen, onClose, reservationData }: ReservationChangeModalProps) {
            ...
            <ModalContainer onClick={(e) => e.stopPropagation()}>
                ...
                <ModalContent>
                    <InfoSection>
                        ...
                        {reservationData.spaceImageUrl && <SpaceImage src={reservationData.spaceImageUrl} alt={reservationData.spaceName} />}
                    ...
                    <FormSection>
                        ...
                        <FormItem>
                            ...
                            <TimeInputContainer>
                                <TimeInput type="time" defaultValue={new Date(reservationData.reservationFrom).toTimeString().substring(0, 5)} />
                                <span>~</span>
                                <TimeInput type="time" defaultValue={new Date(reservationData.reservationTo).toTimeString().substring(0, 5)} />
                            </TimeInputContainer>
                        </FormItem>
                        ...
                        <FormItem>
                            ...
                            <HeadcountContainer>
                                <span>인원</span>
                                <HeadcountControl>
                                    <button onClick={() => setHeadcount(p => Math.max(0, p - 1))}>-</button>
                                    <span>{headcount}</span>
                        ...
                        <FormItem>
                            ...
                            <PurposeInput placeholder="회의나 행사등 공간의 사용 목적을 입력해주세요" defaultValue={reservationData.reservationPurpose} />
                        </FormItem>
                        ...
                        <FormItem>
                            ...
                            <UploadBox>
                               <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 16.5V7.5M12 7.5L8.5 11M12 7.5L15.5 11" stroke="#8C8F93" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><path d="M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3" stroke="#8C8F93" strokeWidth="1.5" strokeLinecap="round"/></svg>
                            </UploadBox>
                ...
                <ModalFooter>
                    <SubmitButton onClick={handleSaveChanges}>예약 수정 완료</SubmitButton>
                </ModalFooter>
            </ModalContainer>
        </ModalOverlay>
    );
...
const ModalContainer = styled.div`
  width: 470px; height: 90vh; display: flex; flex-direction: column;
...
const ModalTitle = styled.h1`
  font-family: 'Pretendard'; font-weight: 600; font-size: 24px;
...
const InfoSection = styled.div`
  padding: 16px 0; border-bottom: 1px solid #E8E9E9;
`;
...
const DetailLabel = styled.p`
  font-size: 16px; font-weight: 500; color: #8C8F93; margin: 0 0 12px 0;
`;
const DetailValue = styled.p`
  font-size: 16px; font-weight: 500; color: #191F28; margin: 0;
`;
const SpaceImage = styled.img`
  width: 100%; height: 190px; border-radius: 8px; object-fit: cover;
...
const TimeInput = styled.input`
    width: 160px; height: 46px; padding: 0 12px;
    border: 1px solid #E8E9E9; border-radius: 8px; font-size: 14px;
    box-sizing: border-box;
`;
const HeadcountContainer = styled.div`
    display: flex; justify-content: space-between; align-items: center;
    color: #191F28; font-size: 16px; font-weight: 600;
`;
const HeadcountControl = styled.div`
    display: flex; align-items: center; gap: 16px;
    button {
        width: 23px; height: 23px; border-radius: 50%;
        border: none; background: #F2F6FF; color: #0046FF; cursor: pointer;
...
const PurposeInput = styled.textarea`
    width: 100%; height: 51px; padding: 16px;
    border: 1px solid #E5E5E5; border-radius: 8px;
    resize: vertical; box-sizing: border-box; font-family: 'Pretendard';
`;
const UploadBox = styled.label`
    width: 100px; height: 92px; background: #F3F4F4; border-radius: 10px;
    display: flex; justify-content: center; align-items: center; cursor: pointer;
`;
const FileListItem = styled.div`
    display: flex; justify-content: space-between; align-items: center;
    padding: 16px 0; border-bottom: 1px solid #E5E5E5; font-size: 16px;
...
const SubmitButton = styled.button`
  width: 100%; height: 46px; background: #0046FF;
