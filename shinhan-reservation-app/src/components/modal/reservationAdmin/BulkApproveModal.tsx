                    ...
                    {reservations.length > 0 ? (
                        reservations.map(res => (
                            <ReservationItem key={res.reservationId}>
                                ...
                                <div style={{ display: 'flex', gap: '0.25rem', fontSize: '0.875rem', fontWeight: 'bold', color: '#333', marginTop: '0.1rem' }}>
                                ...
                                {res.previsits && res.previsits.length > 0 && (
                                    <>
                                    <div style={{ display: 'flex', gap: '0.25rem', fontSize: '0.875rem', color: '#4b5563', marginTop: '0.1rem' }}>
