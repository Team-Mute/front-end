...
export const LOCATION_BASED_TERMS_HTML = `
<style>
  li {
    margin-left: 20px;
  }
 ...
 <br/>
  <h2 style="text-align: center;">위치기반 서비스 이용약관</h2>

  <br/>
  <h3>제1조(목적)</h3>
  <p>
    본 약관은 회원(신한금융희망재단의 서비스 약관에 동의한 자를 말하며 이하 '회원'이라고 합니다)이 신한금융희망재단(이하 '회사'라고 합니다)가 제공하는 웹페이지의 서비스를 이용함에 있어 회원과 회사의 권리 및 의무, 기타 제반 사항을 정하는 것을 목적으로 합니다.
  </p>
...
<br/>
  ...
  <ol>
    ...
    <li>
      회사가 약관을 개정할 경우 기존약관과 개정약관 및 개정약관의 적용일자와 개정사유를 명시하여 현행약관과 함께 그 적용일자 10일 전부터 적용일 이후 상당한 기간 동안 회사의 웹페이지를 통해 공지합니다. 다만, 개정약관의 내용이 회원에게 새로운 의무를 부과하거나 권리를 제한하는 내용인 경우 그 적용일자 30일 전부터 상당한 기간 동안 이를 회사의 웹페이지를 통해 공지하고, 회원에게 전자적 형태로 약관의 개정 사실을 발송하여 고지합니다.
    </li>
  </ol>
...
<br/>
  <h3>제8조(서비스 이용요금)</h3>
  <ol>
    <li>회사의 서비스는 무료제공을 원칙으로 합니다.</li>
    <li>전항에도 불구하고 무선 서비스 이용시 발생하는 데이터 통신료는 별도이며, 이 때 부과되는 데이터 통신료는 회원이 가입한 각 이동통신사의 정책에 따릅니다.</li>
    <li>멀티미디어 메시지 서비스(MMS) 등으로 게시물을 등록할 경우 발생하는 요금은 각 이동통신사의 요금정책에 따라 회원이 부담합니다.</li>
  </ol>


<br/>
  <h3>제9조(서비스내용 변경 통지 등)</h3>
  <ol>
...
<br/>
  ...
  <ol>
    ...
    <li>회사는 타사업자 또는 이용 고객의 민원처리 등을 위해 회원의 위치정보 이용·제공 사실 확인자료를 자동 기록·보존하며, 해당 자료는 1년간 보관합니다.</li>
    <li>
...
<br/>
  <h3>제12조(개인위치정보의 보유기간 및 이용기간)</h3>
  <ol>
    <li>
...
<br/>
  <h3>제14조(위치정보관리책임자의 지정)</h3>
  <ol>
    <li>
      회사는 위치정보를 적절히 관리, 보호하고 개인위치정보주체의 불만을 원활히 처리할 수 있도록 실질적인 책임을 질 수 있는 지위에 있는 자를 위치정보의 관리책임자로 지정하고 운영합니다.
    </li>
    <li>회사의 위치정보관리책임자는 위치기반서비스의 제공에 관한 제반 사항을 담당·관리하는 부서의 개발팀장으로서, 구체적인 사항은 본 약관의 부칙에 따릅니다.</li>
  </ol>
...
<br/>
  ...
  <ol>
    <li>법인명: 신한금융희망재단</li>
    <li>대표이사 : 진옥동</li>
    <li>소재지: 서울 중구 명동10길 52 (충무로2가, 신한은행 명동역지점)</li>
    <li>연락처 : 02-6360-3523</li>
  </ol>
...
<br/>
  <h3>부칙</h3>
  <h4>제1조(시행일)</h4>
  <p>본 약관은 2025.08.08.부터 시행합니다.</p>

  <h4>제2조(위치정보관리책임자)</h4>
  <p>위치정보관리책임자는 를 기준으로 다음과 같이 지정합니다.</p>
  <ol>
    <li>소속: 신한금융희망재단</li>
    <li>성명 : 김신한</li>
    <li>직위: 개발팀장</li>
    <li>전화 : 02-6360-3523</li>
  </ol>
`;
