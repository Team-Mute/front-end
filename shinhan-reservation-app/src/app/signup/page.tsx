      ...
      <SignupForm>
        ...
        <CheckboxWrapper>
          <Checkbox
            ...
            onChange={() => setLocationService((prev) => !prev)}
            label="위치기반서비스 이용약관 (선택)"
            labelClickable={true}
            onLabelClick={() => {
              setTermsContent(LOCATION_BASED_TERMS_HTML);
              setIsTermsOpen(true);
            }}
          />
        </CheckboxWrapper>
        <CheckboxWrapper>
          <Checkbox
            checked={smsConsent}
            onChange={() => setSmsConsent((prev) => !prev)}
            label="예약 알림 SMS 수신 (선택)"
          />
        </CheckboxWrapper>
        <CheckboxWrapper>
          <Checkbox
