...
const summaryData: SummaryItem[] = [
    { label: '1차 승인 대기', count: 15 },
    { label: '2차 승인 대기', count: 4 },
    { label: '긴급', count: 1 },
    { label: '신한', count: 1 },
];
...
// --- 컴포넌트 ---
const SummaryCard = ({ item }: { item: SummaryItem }) => (
    <CardContainer>
        <Badge status={item.label}>{item.label}</Badge>
...
// (GridWrapper, GridBody, DayCell, DayLabel, TodayLabel 스타일은 이전 답변과 동일하게 유지)
